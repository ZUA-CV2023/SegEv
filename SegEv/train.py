...
parser.add_argument('--resume', default="weights/minisegnet_resnet50_54_800000.pth", type=str,
...
parser.add_argument('--config', default='minisegnet_coco_custom_config',
...
def train():
    ...
    # log_dir = os.path.join(logs_path, "loss_" + str(time_str))
    # # 构建 SummaryWriter
    # writer = SummaryWriter(log_dir, comment='loss_comment', filename_suffix="_loss_suffix")
    ...
    try:
        for epoch in range(50):
            ...
            for datum in data_loader:
                ...
                plt.ylabel("loss")
                plt.title("loss_map")
                output_dir = "./loss_testfiles"
                if not os.path.exists(output_dir):
                    os.makedirs(output_dir)
                path_feature_img = os.path.join(output_dir, "loss_map" + ".png")
                plt.savefig(path_feature_img, dpi=300)
