...
def parse_args(argv=None):
    ...
    parser.add_argument('--trained_model',
                        default='weights/minisegnet_resnet50_54_800000.pth', type=str,
